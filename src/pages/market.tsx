        ...
        <div>
            ...
            <div className="grid grid-cols-12">
                ...
                <div className="col-span-7">
                    ...
                    <div>
                    <a href="#" className=" ml-10 mt-5 inline-flex items-center px-3 mr-5 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <button>buy</button>
                            </a>
                    </div>
                </div>
